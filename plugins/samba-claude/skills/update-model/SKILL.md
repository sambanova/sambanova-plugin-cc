...
3. Once all fields are confirmed, run `${SAMBA_CLAUDE_PYTHON} ${CLAUDE_SKILL_DIR}/update_model.py <name> <context_length> <max_completion_tokens> [sampling_parameters_json]`
