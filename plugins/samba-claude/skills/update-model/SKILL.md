...
3. Once all fields are confirmed, run `${CLAUDE_PLUGIN_DIR}/.env/bin/python3 ${CLAUDE_SKILL_DIR}/update_model.py <name> <context_length> <max_completion_tokens> [sampling_parameters_json]`
